...
function changeskin() {
    ...
    $lis.each(function(index) {
        ...
        $(".close-setskin").on("click", function() {
            var srcs = $container.css("background", "#fff");
...
function listenScorll() {
    ...
    var numberVaule = document.getElementById("number").innerHTML
    document.getElementById("number").innerHTML = document.getElementById("opacity").value;
